...
const Card = ({ title,id,desc,img,link,fetchproject }) => {
...
<div className="relative flex w-80 h-[65%] mt-8 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md"  >
          <div className="mx-4 -mt-6 h-40 rounded-lg  bg-clip-border text-black shadow-lg shadow-blue-gray-500/40 ">
           <img src={img} alt={title} className="rounded-xl shadow-lg drop-shadow-lg" />
          </div>
          <div className="mt-16">
            <h5 className="mb-2 block px-5 font-sans text-xl font-semibold leading-snug tracking-normal text-blue-gray-900 antialiased">
              {title} 
            </h5>
            <p className="block px-5 font-sans text-base font-light leading-relaxed text-inherit antialiased">
               {desc} 
          ...
          <div className="flex flex-row w-full justify-start">
           ...
           <ul className="list-none flex flex-row gap-2 p-4" >
              ...
              <li className="bg-pink-600 text-sm text-white rounded-[50%] p-3 cursor-pointer" onClick={ ()=>{handleDelete(id)}}><Trash/></li>
